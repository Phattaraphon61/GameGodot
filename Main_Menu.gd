...
export (String, FILE) var ubuscene
...
func _ready():
	...
	$Level_Select_Menu/Button_Level_ubuscene.connect("pressed", self, "level_select_menu_button_pressed", ["ubuscene"])
...
func level_select_menu_button_pressed(button_name):
	...
	elif button_name == "ubuscene":
		set_mouse_and_joypad_sensitivity()
		get_node("/root/Globals").load_new_scene(ubuscene)
